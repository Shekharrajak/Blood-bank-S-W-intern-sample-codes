...
public class Blood_Info extends Screen {
 ...
 public Blood_Info() {
   ...
   * and combo box
   */
  super("Blood_Info", new String[] { "Blood Group: ", "Vehicle No:", "Donor Name:", "Donor Contact No:",
    "Donate Date:", "Driver ID:", "Donated quantity:", "City (Where blood is donated):", "Donor E-mail:",
    "Donor's DOB:", "Donor's work:" }, 11);
  /**
   * 
