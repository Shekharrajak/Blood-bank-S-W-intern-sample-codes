...
public class EditBlood_Info extends JFrame {

 /**
	 * 
	 */
	private static final long serialVersionUID = 5146554959588130225L;
private JPanel contentPane;
 ...
 public static void main(String[] args) {
  EventQueue.invokeLater(new Runnable() {
   public void run() {
    try {
     EditBlood_Info frame = new EditBlood_Info();
